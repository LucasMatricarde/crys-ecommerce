# storefront-order-tracking Specification

## Purpose

Defines the storefront order-tracking view that polls the CQRS read model, tolerates eventual-consistency lag (initial `404`), stops on terminal states, and reflects the backend's known demo end-to-end outcomes.
