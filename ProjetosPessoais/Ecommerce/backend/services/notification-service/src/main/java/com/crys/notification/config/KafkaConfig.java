package com.crys.notification.config;
...
/**
 * Kafka wiring for this consumer. Envelopes travel as JSON strings, so String
 * (de)serializers are used. A failing record is retried then routed to
